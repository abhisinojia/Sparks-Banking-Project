...
<body>
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        ...
        <a href="history.php"><button type="button" class="btn btn-dark btn-lg mb-3" style="background-color: #0f4c75; color: #bbe1fa;">See all Transaction History</button></a>
    </div>
    </div>
 ...
 <div class="container">
        ...
        <h2 class="text-center pt-4" style="color: #0f4c75;">Transer Money Here !</h2>
